...
double WHEEL_RADIUS = 1.379;

//Starting angle (relative to field) (RADIANS)
double THETA_START = PI; //imagine the field is a unit circle

double X_START = 0; 
double Y_START = 0;

//Distances of tracking wheels from tracking center (INCHES)
double rTrackRadius = 6.8335;
double lTrackRadius = 6.8335;
double bTrackRadius = 5.85;
